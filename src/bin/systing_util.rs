//! systing-util: Utility tools for trace file conversion and validation
//!
//! This tool converts Perfetto trace files directly to DuckDB databases for efficient
//! analysis, and validates trace data for correctness.
...
#[derive(Parser)]
#[command(name = "systing-util")]
#[command(about = "Utility tools for trace file conversion and validation")]
#[command(version)]
struct Cli {
    #[command(subcommand)]
    command: Commands,
